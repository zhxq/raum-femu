...
static const Property femu_props[] = {
    ...
    DEFINE_PROP_INT32("zns_zrwafg", FemuCtrl, zns_params.zns_zrwafg, -1),
    DEFINE_PROP_UINT32("zns_max_active", FemuCtrl,
                       zns_params.max_active_zones, 14),
    DEFINE_PROP_UINT32("zns_max_open", FemuCtrl,
                       zns_params.max_open_zones, 14),
