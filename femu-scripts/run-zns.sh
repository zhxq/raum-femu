...
FEMU_OPTIONS=${FEMU_OPTIONS}",zns_max_active=${MAX_ACTIVE}"
FEMU_OPTIONS=${FEMU_OPTIONS}",zns_max_open=${MAX_OPEN}"
FEMU_OPTIONS=${FEMU_OPTIONS}",zns_zrwas=${ZRWA_SZ}"
FEMU_OPTIONS=${FEMU_OPTIONS}",zns_num_zrwa=${NUM_ZRWA}"
FEMU_OPTIONS=${FEMU_OPTIONS}",zns_zrwafg=${ZRWA_FG}"
